...
export const metadata: Metadata = {
  ...
  description: "Retrouve tous tes tirages passés et messages vibratoires.",
};
...
export default async function HistoriquePage() {
  ...
  if (!userKey) {
    redirect("/login?callbackUrl=/mon-espace/historique");
  }
    ...
    <div className="space-y-16">
      <header className="space-y-5">
        ...
        <p className="max-w-2xl text-base leading-relaxed text-[#1A1A1A]/70">
          Un lieu sacré où l&apos;Oracle conserve la trace de tes tirages passés. Chaque message est
          une pierre blanche sur ton chemin.
        </p>
      </header>
